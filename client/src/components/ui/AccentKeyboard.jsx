...
const AccentKeyboard = ({ typeAccent, updateDisplay, displayKeyboard }) => {
   const height = displayKeyboard ? { height: 52 } : { height: 0 };
   ...
   return (
      <div className='flex flex-col gap-1'>
         ...
         <div className='flex justify-center px-1'>
            <div style={height} className='flex gap-1 max-w-50 justify-center flex-wrap overflow-hidden transition-[height] duration-200'>
